...
export default function MovieCard(props) {
    const { name, score, image,id } = props;
    const [showModal, setShowModal] = useState(false);
    return (
        
            <figure className="text-white bg-[#1B263B] w-[255px] h-[545px] p-1 m-1">
               <a href={`details/${id}`}><div className="overflow-hidden"><img className="h-[355px] hover:brightness-50" src={image?.original ?? <p>No</p>} alt="" /></div></a>
                <figcaption>
