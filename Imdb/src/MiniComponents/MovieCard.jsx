...
export default function MovieCard(props) {
    const { name, score, image } = props;
    const [showModal, setShowModal] = useState(false);
    return (
        
            <figure className="text-white bg-[#1B263B] w-[255px] h-[545px] p-1 m-1">
               <a href=""><div className="overflow-hidden"><img className="h-[355px] hover:brightness-50" src={image?.original ?? <p>No</p>} alt="" /></div></a>
                <figcaption>
                    ...
                    <div className="flex justify-around">
                        <button className="w-20 rounded-md h-8 bg-[#778DA9]">Trailer</button>
                        <button
