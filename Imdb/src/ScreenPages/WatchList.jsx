    ...
    return (
        ...
        <div className="flex">
            {props.map((prop, index) => (
                <figure key={index} className="relative text-white bg-[#1B263B] w-[300px] h-[500px] sm:w-[255px] sm:h-[545px] p-1 m-1 slide">
                    <a href={`details/${prop.id}`}>
                        <div className="overflow-hidden">
                            <img className="h-[320px] sm:h-[355px] hover:brightness-50" src={prop.image?.original ?? <p>No</p>} alt="" />
                        </div>
                    </a>
                    <figcaption>
                        <div className="flex flex-col">
                            <div className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 15 14" fill="">
                                ...
                                <span className="text-xl">{(prop.score * 10).toFixed(1)}</span>
                            </div>
